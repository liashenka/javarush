...
public class Solution {
    ...
    protected void updateLastDate(long delta) {
        dates.remove(lastDate);   //Das Problemm, dass Hashset sucht die Elemente nach Hashcode,
                                    //Deswegen muss man lastDate aus HashSet löshen
        lastDate.setTime(lastDate.getTime() + delta);   //dann updaten
        dates.add(lastDate);                            //danach wider hinzufügen
    }
}
