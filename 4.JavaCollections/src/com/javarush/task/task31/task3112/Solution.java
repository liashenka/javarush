...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        Path passwords = downloadFile("https://javarush.ru/testdata/secretPasswords.txt", Paths.get("/Users/maria/javasrc/test/"));
    ...
    public static Path downloadFile(String urlString, Path downloadDirectory) throws IOException {
        ...
        inputStream.close();
        Path result =Paths.get(downloadDirectory.toAbsolutePath() + fileName);
